...
1. [x] Iterate over the items in the target directory. For each of them, record the name, file size, and whether it's a directory itself. Use this data to build and return a string representing the contents of the target directory. It should be in the following format:
